        ...
        while True:
            if nonlocal_variables['executing_action']:
                ...
                if stage == 'grasp_only':
                    ...
                    print("I am going to grasp non goal")
                    print("---------------")
                    if best_grasp_conf > 2.1 or nonlocal_variables['push_step'] == max_push_episode_length:
                        print("I am going to grasp goal")
                        nonlocal_variables['primitive_action'] = 'grasp'
        ...
        if 'prev_color_img' in locals():
            ...
            if not is_testing:
                ...
                if trainer.iteration % 50 == 0:
                    logger.save_model(trainer.iteration, trainer.model, stage, optimizerState)
                    if trainer.use_cuda:
